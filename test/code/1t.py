...
angle_height = 64 # 63
frame_rate = 23
camera_separation = 2.2 + 15/16

# left camera 1
ct1 = tt.Camera_Thread()
ct1.camera_source = camera_src
...
try:
    while 1:
        # get frames
        frame1, frame2 = ct1.next(black=True,wait=1)
        ...
        fps2 = int(ct1.current_frame_rate)
    ...
    ct1.camera.release()  # Release both capture objects if you have multiple
